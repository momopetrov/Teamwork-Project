class UserView {
    ...
    showLoginPage(isLoggedIn){
        ...
        if(isLoggedIn)
        {
            templateUrl = "templatees/form-user.html"
        }
        else
        {
            templateUrl = "templatees/form-guest.html"
        }
        ...
        $.get(templateUrl, function(template) {
            ...
            $.get('templatees/login.html', function(template) {
    ...
    showRegisterPage(isLoggedIn){
        let _that = this;
        let requestTemplate = isLoggedIn ? 'templatees/form-user.html' : 'templatees/form-guest.html';
        $.get(requestTemplate, function (template) {
            ...
            $.get('templatees/register.html', function(template) {
                let rendered = Mustache.render(template, null);
                $(_that._mainContentSelector).html(rendered);
    ...
    showGalleryPage(isLoggedIn){
        ...
        $.get(templateUrl, function(template) {
            ...
            $.get('templatees/gallery.html', function(template) {
                let rendered = Mustache.render(template, null);
                $(_that._mainContentSelector).html(rendered);
            })
        });
    ...
    showContactUs(isLoggedIn){
        ...
        $.get(templateUrl, function(template) {
            ...
            $.get('templatees/contactus.html', function(template) {
                let rendered = Mustache.render(template, null);
                $(_that._mainContentSelector).html(rendered);
